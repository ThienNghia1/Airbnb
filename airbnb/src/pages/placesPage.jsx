                    ...
                    <form>
                        ...
                        <div className="flex gap-2 gird grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
                            {addPhoto.length > 0 && addPhoto.map(link =>(
                                <div>
                                    <img className="rounded-full" src={'http://localhost:4000/uploads/' + link} alt="" />
                                </div>
                            ))}
                            <button className="flex justify-between flex gap-2 text-xl border bg-transparent p-10 rounded-2xl">
